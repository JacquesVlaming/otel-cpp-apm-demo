...
foreach(_cmake_expected_target IN ITEMS gRPC::cares gRPC::re2 gRPC::ssl gRPC::crypto gRPC::address_sorting gRPC::gpr gRPC::grpc gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpc++_unsecure gRPC::grpc_plugin_support gRPC::grpcpp_channelz gRPC::upb gRPC::grpc_cpp_plugin)
...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "dl;m;Threads::Threads;rt;absl::base;absl::core_headers;absl::memory;absl::random_random;absl::status;absl::cord;absl::str_format;absl::strings;absl::synchronization;absl::time;absl::optional;absl::variant"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ZLIB::ZLIB;gRPC::cares;gRPC::address_sorting;gRPC::re2;gRPC::upb;dl;m;Threads::Threads;rt;absl::flat_hash_map;absl::flat_hash_set;absl::inlined_vector;absl::any_invocable;absl::bind_front;absl::function_ref;absl::hash;absl::type_traits;absl::statusor;absl::span;absl::utility;gRPC::gpr;gRPC::ssl;gRPC::crypto;gRPC::address_sorting;gRPC::upb"
)
...
set_target_properties(gRPC::grpc++ PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf;dl;m;Threads::Threads;rt;absl::cleanup;gRPC::grpc"
)
...
set_target_properties(gRPC::grpc++_alts PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf;dl;m;Threads::Threads;rt;gRPC::grpc++"
)
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotobuf;dl;m;Threads::Threads;rt;gRPC::grpc_unsecure"
)
...
set_target_properties(gRPC::grpc_plugin_support PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libprotoc;protobuf::libprotobuf;dl;m;Threads::Threads;rt"
)
...
foreach(_target "absl::base" "absl::core_headers" "absl::memory" "absl::random_random" "absl::status" "absl::cord" "absl::str_format" "absl::strings" "absl::synchronization" "absl::time" "absl::optional" "absl::variant" "absl::flat_hash_map" "absl::flat_hash_set" "absl::inlined_vector" "absl::any_invocable" "absl::bind_front" "absl::function_ref" "absl::hash" "absl::type_traits" "absl::statusor" "absl::span" "absl::utility" "protobuf::libprotobuf" "absl::cleanup" "protobuf::libprotoc" )
