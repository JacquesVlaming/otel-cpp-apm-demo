...
foreach(_cmake_expected_target IN ITEMS opentelemetry-cpp::otlp_grpc_client opentelemetry-cpp::proto_grpc opentelemetry-cpp::otlp_grpc_exporter opentelemetry-cpp::otlp_grpc_log_record_exporter opentelemetry-cpp::otlp_grpc_metrics_exporter)
...
set_target_properties(opentelemetry-cpp::otlp_grpc_client PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::sdk;opentelemetry-cpp::common"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/opentelemetry-cpp-exporters_otlp_grpc-target-*.cmake")
...
foreach(_target "opentelemetry-cpp::sdk" "opentelemetry-cpp::common" "opentelemetry-cpp::proto" "gRPC::grpc++" "opentelemetry-cpp::otlp_recordable" )
