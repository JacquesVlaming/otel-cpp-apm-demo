...
foreach(_cmake_expected_target IN ITEMS opentelemetry-cpp::in_memory_span_exporter opentelemetry-cpp::in_memory_metric_exporter)
...
add_library(opentelemetry-cpp::in_memory_metric_exporter SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/opentelemetry-cpp-exporters_in_memory-target-*.cmake")
...
foreach(_target "opentelemetry-cpp::trace" "opentelemetry-cpp::metrics" )
