...
foreach(_cmake_expected_target IN ITEMS opentelemetry-cpp::otlp_recordable opentelemetry-cpp::proto)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/opentelemetry-cpp-exporters_otlp_common-target-*.cmake")
...
foreach(_target "opentelemetry-cpp::logs" "opentelemetry-cpp::metrics" "opentelemetry-cpp::trace" "opentelemetry-cpp::resources" "protobuf::libprotobuf" )
