...
set_target_properties(protobuf::libprotobuf-lite PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libprotobuf-lite.so.3.21.6.0"
  IMPORTED_SONAME_NOCONFIG "libprotobuf-lite.so.32"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotobuf-lite )
list(APPEND _cmake_import_check_files_for_protobuf::libprotobuf-lite "${_IMPORT_PREFIX}/lib64/libprotobuf-lite.so.3.21.6.0" )
...
set_target_properties(protobuf::libprotobuf PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libprotobuf.so.3.21.6.0"
  IMPORTED_SONAME_NOCONFIG "libprotobuf.so.32"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotobuf )
list(APPEND _cmake_import_check_files_for_protobuf::libprotobuf "${_IMPORT_PREFIX}/lib64/libprotobuf.so.3.21.6.0" )
...
set_target_properties(protobuf::libprotoc PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libprotoc.so.3.21.6.0"
  IMPORTED_SONAME_NOCONFIG "libprotoc.so.32"
  )

list(APPEND _cmake_import_check_targets protobuf::libprotoc )
list(APPEND _cmake_import_check_files_for_protobuf::libprotoc "${_IMPORT_PREFIX}/lib64/libprotoc.so.3.21.6.0" )
...
set_target_properties(protobuf::protoc PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/bin/protoc-3.21.6.0"
  )

list(APPEND _cmake_import_check_targets protobuf::protoc )
list(APPEND _cmake_import_check_files_for_protobuf::protoc "${_IMPORT_PREFIX}/bin/protoc-3.21.6.0" )
